...
export const certifications = [
  {
    ...
    subtitle: "جایگاه تصویر گواهی اعتبار و دامنه فعالیت",
  },
  {
    title: "تاییدیه همکاری صنعتی",
    subtitle: "جایگاه تصویر تاییدیه یا مجوز همکاری با نهادهای مرتبط",
  },
  {
    title: "گواهی ارزیابی فنی",
    subtitle: "جایگاه تصویر گواهی ارزیابی فنی و انطباق محصول",
  },
  {
    title: "گزارش نمونه پروژه",
    subtitle: "جایگاه تصویر گزارش یا گواهی پروژه‌های انجام شده",
  },
]

export const blogPosts = [
  {
    title: "راهنمای شروع فرایند اخذ تاییدیه استاندارد",
    summary:
      "مروری کوتاه بر آماده‌سازی مدارک، انتخاب آزمون مناسب و کاهش خطاهای رایج در شروع مسیر استانداردسازی.",
    date: "۱۴ تیر ۱۴۰۵",
    category: "استاندارد",
    image: labImage,
    href: "#contact",
  },
  {
    ...
    summary:
      "بررسی نقش کنترل کیفیت ساختارمند در کاهش ضایعات، افزایش پایداری خط و بهبود اعتماد مشتری نهایی.",
    date: "۱۱ تیر ۱۴۰۵",
  ...
  },
  {
    ...
    summary:
      "چک‌لیستی کاربردی برای انتخاب تجهیزات، طراحی فضا و برنامه‌ریزی دقیق پیش از راه‌اندازی آزمایشگاه.",
    date: "۶ تیر ۱۴۰۵",
